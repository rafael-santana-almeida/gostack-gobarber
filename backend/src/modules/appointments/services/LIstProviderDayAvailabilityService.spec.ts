...
let listProvideDayhAvailability: ListProviderDayAvailabilityService;

describe('ListProviderDayAvailability', () => {
  beforeEach(() => {
    fakeAppointmentsRepository = new FakeAppontmentsRepository();
    listProvideDayhAvailability = new ListProviderDayAvailabilityService(
  ...
  it('should be able to list the day availability from provider', async () => {
    ...
    const availability = await listProvideDayhAvailability.execute({
      provider_id: 'user',
      year: 2021,
      month: 5,
      day: 20,
