...
# Agendamento ed serviços

**RF**

- O usuário deve poder listar todos prestadores de serviço casdastrados;
...
- Os agendamentos devem estar disponíveis entre 8h às 18h (Primeiro às 8h, último às 17hr);
